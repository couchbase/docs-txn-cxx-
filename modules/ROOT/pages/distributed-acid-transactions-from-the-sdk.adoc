...
For a full {cpp}  implementation of the transactions API _and_ SDK see the https://docs.couchbase.com/cxx-sdk/current/howtos/distributed-acid-transactions-from-the-sdk.html[Couchbase {cpp} SDK implementation of transactions].
